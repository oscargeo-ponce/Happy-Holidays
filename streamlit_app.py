...
LOTTIE_ANIMATION = ASSETS / "Reindeer_Animation.json"
...
def get_person_name():
  ...
  return query_params.get("name", ["everyone"])[0]
...
st.markdown(
  f"Wishing {PERSON_NAME} a wonderful holiday season filled with joy and peace ❤️"
)
